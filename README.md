...
<ul>
  <li>Practicing on TryHackMe</li>
  <li>Exploring labs on Hack The Box</li>
  <li>Building hands-on cybersecurity skills daily</li>
</ul>
...
<ul>
  <li>🌐 Networking (TCP/IP, DNS, HTTP)</li>
  <li>🐧 Linux Fundamentals</li>
  <li>🌍 Web Application Basics</li>
  <li>🔍 Enumeration & Recon</li>
</ul>
...
<h2>🛠 Tools</h2>
<p>
  Kali Linux • Nmap • Wireshark • Burp Suite • Gobuster • Netcat
</p>
...
<ul>
  ...
  <li>🧪 Practice Labs (TryHackMe & Hack The Box)</li>
  <li>✍️ Writeups (Coming Soon)</li>
</ul>
...
<p align="center">🔥 Stay Consistent | Keep Learning | Keep Hacking 🔥</p>
